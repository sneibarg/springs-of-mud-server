...
class ItemUtil:
    ...
    def can_see_object(room_helper: RoomHelper, character: Character, obj: Item) -> bool:
        ...
        if not CharacterMacros.is_npc(character) and CharacterMacros.is_set(int(CharacterMacros.convert_flags(character.status_flags.act)), PlayerActBits.PLR_HOLYLIGHT.value):
            return True
